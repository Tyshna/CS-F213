...
public class Car
{
	...
	public Car max_grand_total(Car[] a)
	{
		Car maxCar = a[0];
	    for (int i = 1; i < a.length; i++) 
	    {
	        if (a[i].grand_total > maxCar.grand_total)
	            maxCar = a[i];
	    }//for
	    return maxCar;
	}//max_grand_total
	...
	public static void main(String args[])
	{
		...
		Car max_car = obj1[0].max_grand_total(obj1);
		System.out.println("Maximun Grand Total:");
		System.out.println("Vehicle ID: "+max_car.Vehicle_id);
		System.out.println("Grand Total Amount: "+max_car.grand_total);
